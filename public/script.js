var w = c.width = window.innerWidth,
    ...
    opts = {
        ...
        rootColor: 'hsla(196,98%,47%,alp)',
        endColor: 'hsla(86,51%,48%,alp)',
        dataColor: 'hsla(40,80%,light%,alp)',

        wireframeWidth: .1,
        wireframeColor: '#32393a',
...
Connection.prototype.draw = function(){
    ...
    ctx.beginPath();
    ctx.arc( this.screen.x, this.screen.y, (this.screen.scale * this.size < 0 ? this.size : this.screen.scale * this.size), 0, Tau );
    ctx.fill();
}
